...
public class Main 
{
    ...
    public static Pokemon[] coutingSort(int len){
        ...
        //for(int i = 0; i < len; count[lista.get(i).getCaptureRate()]++, i++);
        for(int i = 0; i < len; i++)
        {
        ...
        //for(int i = len - 1; i >= 0; ordenado[count[array[i].getCaptureRate()] - 1] = array[i], count[array[i].getCaptureRate()]--, i--);
    ...
    public static void main(String args[])
    {
        ...
        tp.ordenacaoFile("800643_countingsort.txt");
