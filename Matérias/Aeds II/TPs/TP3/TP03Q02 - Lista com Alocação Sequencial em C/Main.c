    ...
    Pokemon removerFim(Lista *list)
    {
        if(list->tam == 0)
        {
            printf("Erro ao remover no fim! Lista vazia");
            exit(1);
        }

        list->tam--;
        Pokemon resp = list->array[list->tam];
    ...
    Pokemon removerInicio(Lista *list)
    {
        if(list->tam == 0)
        {
            printf("Erro ao remover no inicio! Lista vazia");
            exit(1);
        }

        Pokemon resp = list->array[0];
        list->tam--;
    ...
    Pokemon remover(Lista *list, int pos)
    {
        ...
        {
            printf("Posição invalida para remover");
            exit(1);
        }
        else if(list->tam == 0)
        {
        ...
        Pokemon resp = list->array[pos];

        list->tam--;
        for(int i = pos; i < list->tam; i++)
        {
            list->array[i] = list->array[i + 1];
        }
    ...
    void mostrar(Lista *list)
    {
        ...
        {
            printf("[%d] ", i);
            printPokemon(list->array[i]);
        }
    }

    //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//

    void comando(Lista *list, char* id)
    {
        ...
        {
            int pos = atoi(splitted[1]);
            Pokemon x = remover(list, pos);
            printf("(R) %s\n", x.name);

        }
        else if(strcmp(splitted[0], "RI") == 0)
        {
            Pokemon x = removerInicio(list);
            printf("(R) %s\n", x.name);
        }
        else if(strcmp(splitted[0], "RF") == 0)
        {
            Pokemon x = removerFim(list);
            printf("(R) %s\n", x.name);
        }
    ...
    int main()
    {
        ...
        for(int i = 0; i < len; i++)
        {
            inserirFim(&list, pokemons[ids[i]]);
        }
