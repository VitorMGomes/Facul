...
class BST {
    ...
    boolean pesquisar(String string) {
        System.out.println(string);
        System.out.print("=>raiz ");
        return pesquisar(string, raiz);
    }

    boolean pesquisar(String string, No no) {
        boolean resp;
        ...
        if (no == null) {
            ...
            resp = pesquisar(string, no.dir);
        } else {
            System.out.print("esq ");
            resp = pesquisar(string, no.esq);
        }
...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        {
            System.out.print(arvore.pesquisar(name) ? "SIM\n" : "NAO\n");
