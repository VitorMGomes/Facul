...
class ListaSequencial {
    ...
    public ListaSequencial(int tamanho) {
        lista = new Character[tamanho];
        n = 0;
    }

    public void inserirInicio(Character x) throws Exception {
        if (n >= lista.length) {
    ...
    public void inserirFim(Character x) throws Exception {
...
public class Q1 {
    ...
    public static ListaSequencial lista = new ListaSequencial(100);
