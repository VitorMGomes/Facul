...
// cat pub.in | java Q3 > saida.out -- "/tmp/characters.csv"
...
public class Q3 {
    ...
    public static boolean pesquisaSeq(String name, int n, TP tp)
    {
        boolean have = false;
    ...
    public static void main(String args[]) throws Exception {
        ...
        for(String name = scanf.nextLine(); !name.equals("FIM"); name = scanf.nextLine())
        {
            System.out.println(pesquisaSeq(name, n, tp) ? "SIM" : "NAO");
        }

        tp.endTime();

        tp.pesquisaFile("800643_sequencial.txt");
